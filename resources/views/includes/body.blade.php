...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script src="https://kit.fontawesome.com/21e05190ed.js" crossorigin="anonymous"></script>
    ...
    /* Hover padrão para links (exceto botões personalizados) */
    ...
    /* Botão "Entrar" */
    #menu-list a[style*="background-color: #00B37E;"] {
    background-color: #00B37E; /* Verde */
    color: #fff; /* Texto branco */
    padding: 0.5rem 1rem; /* Espaçamento interno */
    border-radius: 5px; /* Bordas arredondadas */
    }

    #menu-list a[style*="background-color: #00B37E;"]:hover {
    background-color: #00875F; /* Verde mais escuro no hover */
    }

    /* Botão "Cadastrar" */
    #menu-list a[style*="background-color: #81D8F7;"] {
    background-color: #81D8F7; /* Azul claro */
    color: #fff; /* Texto branco */
    padding: 0.5rem 1rem;
    border-radius: 5px;
    }

    #menu-list a[style*="background-color: #81D8F7;"]:hover {
    background-color: #63BFE3; /* Azul escuro no hover */
    }

    /* Botão "Terminar sessão" */
    #menu-list a[style*="background-color: #F75A68;"] {
    background-color: #F75A68; /* Vermelho */
    color: #fff; /* Texto branco */
    padding: 0.5rem 1rem;
    border-radius: 5px;
    }

    #menu-list a[style*="background-color: #F75A68;"]:hover {
    background-color: #D64050; /* Vermelho escuro no hover */
    }
    .footer-container {
      display: flex;
      flex-wrap: wrap;
...
<body class="font-sans antialiased bg-white">
    <div class="min-h-screen">
        ...
        <!-- Header -->
        @section('header')
        <header style="background-color: #2B293D; margin:0;" class="shadow py-6">
            <!-- Barra Superior -->
            <div class="w-full px-6 flex justify-between items-center">
                <!-- Nome da Empresa -->
                <div class="text-2xl font-semibold text-gray-800 px-6 flex items-center">
                    <div style="width: 30px; height: 30px;">
                        <img src="{{asset('storage/ticket.png')}}" alt="" style="width: 100%; height: 100%;">
                    </div>
                  <span style="color: #FFE047; font-size:30px; font-weight:bold;" class="font-mono">Eventify</span>
                </div>
                ...
                <nav class="flex items-center gap-6">
                    <ul class="flex gap-4 text-gray-700 font-medium" id='menu-list'>
                        ...
                        @endguest
                        @auth
                        <li><a href="{{route('your.event')}}" class=" text-black p-2 rounded-md transition">Eventos</a></li>
                        <li><a href="/profile" class=" text-black p-2 rounded-md transition">Perfil</a></li>
                        <li><a href="/event/form" style="background-color: #00B37E;" class=" text-black px-4 py-2 rounded-md transition">Criar Evento</a></li>
                        <li><a href="/logout" style="background-color: #F75A68;" class=" text-black px-4 py-2 rounded-md transition">Terminar sessão</a></li>
                        @endauth
                    </ul>
                </nav>
            </div>
        ...
        <footer class="bg-gray-800 text-white py-4">
            ...
            <div class="text-center text-sm p-2" style="border-top: 2px solid #2B293D; margin: 0px 6px;">
